...
void applyTransformToObject(Object * obj, GLfloat * mat);

AnimDirection
getActualAnimDirection(CompWindow * w, AnimDirection dir, Bool openDir);
...
void perspectiveDistortAndResetZ(CompScreen * s, CompTransform * wTransform);
...
void fxCurvedFoldModelStep(CompWindow * w, float time);

void fxFoldUpdateWindowAttrib(CompWindow * w, WindowPaintAttrib * wAttrib);

Bool fxCurvedFoldZoomToIcon(CompWindow * w);

/* dodge.c */

void fxDodgePostPreparePaintScreen(CompWindow * w);

void fxDodgeUpdateWindowTransform(CompWindow * w, CompTransform * wTransform);

void fxDodgeAnimStep(CompWindow * w, float time);

void fxDodgeUpdateBB(CompOutput * output, CompWindow * w, Box * BB);
...
void fxFocusFadeUpdateWindowAttrib(CompWindow * w, WindowPaintAttrib * wAttrib);

/* glide.c */

Bool fxGlideInit(CompWindow * w);

void fxGlideUpdateWindowAttrib(CompWindow * w, WindowPaintAttrib * wAttrib);

void fxGlideAnimStep(CompWindow * w, float time);

float fxGlideAnimProgress(CompWindow * w);

void fxGlideUpdateWindowTransform(CompWindow * w, CompTransform * wTransform);

void fxGlidePrePaintWindow(CompWindow * w);

void fxGlidePostPaintWindow(CompWindow * w);

Bool fxGlideZoomToIcon(CompWindow * w);
...
Bool fxHorizontalFoldsZoomToIcon(CompWindow * w);

/* magiclamp.c */

void fxMagicLampInitGrid(CompWindow * w, int *gridWidth, int *gridHeight);

void fxVacuumInitGrid(CompWindow * w, int *gridWidth, int *gridHeight);

Bool fxMagicLampInit(CompWindow * w);

void fxMagicLampModelStep(CompWindow * w, float time);

/* options.c */

void updateOptionSets(CompScreen * s, AnimEvent e);

void freeAllOptionSets(AnimScreen * as);

CompOptionValue *animGetPluginOptVal(CompWindow * w,
...
void fxRollUpInitGrid(CompWindow * w, int *gridWidth, int *gridHeight);

Bool fxRollUpAnimInit(CompWindow * w);

/* wave.c */

void fxWaveModelStep(CompWindow * w, float time);

/* zoomside.c */

void fxZoomUpdateWindowAttrib(CompWindow * w, WindowPaintAttrib * wAttrib);

void
fxZoomAnimProgress(CompWindow * w,
		   float *moveProgress,
		   float *scaleProgress, Bool neverSpringy);

Bool fxSidekickInit(CompWindow * w);

Bool fxZoomInit(CompWindow * w);

void applyZoomTransform(CompWindow * w);

void getZoomCenterScale(CompWindow * w, Point * pCurCenter, Point * pCurScale);
