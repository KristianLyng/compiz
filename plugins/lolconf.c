...
static void
lolFini (CompPlugin *p)
{
    freeCorePrivateIndex (corePrivateIndex);
}

static CompMetadata *
lolGetMetadata (CompPlugin *plugin)
{
    return &lolMetadata;
}
