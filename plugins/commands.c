...
static CompBool commandsInitDisplay(CompPlugin * p, CompDisplay * d)
{
	CommandsDisplay *cd;
	int i;
...
static void commandsFiniDisplay(CompPlugin * p, CompDisplay * d)
{
	COMMANDS_DISPLAY(d);
...
static CompOption *commandsGetDisplayOptions(CompPlugin * p,
...
static CompBool commandsInitObject(CompPlugin * p, CompObject * o)
{
...
static void commandsFiniObject(CompPlugin * p, CompObject * o)
{
...
static CompOption *commandsGetObjectOptions(CompPlugin * p,
...
static Bool commandsInit(CompPlugin * p)
{
...
static void commandsFini(CompPlugin * p)
{
	freeDisplayPrivateIndex(displayPrivateIndex);
	compFiniMetadata(&commandsMetadata);
}

static CompMetadata *commandsGetMetadata(CompPlugin * p)
{
