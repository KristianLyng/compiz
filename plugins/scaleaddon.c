...
static void scaleaddonRenderWindowTitle(CompWindow * w)
{
...
static void scaleaddonDrawWindowHighlight(CompWindow * w)
{
	GLboolean wasBlend;
...
static void scaleaddonCheckWindowHighlight(CompScreen * s)
{
...
static void scaleaddonHandleEvent(CompDisplay * d, XEvent * event)
{
	ADDON_DISPLAY(d);
...
scaleaddonScreenOptionChanged(CompScreen * s,
			      CompOption * opt, ScaleaddonScreenOptions num)
{
	switch (num) {
...
static Bool scaleaddonInitDisplay(CompPlugin * p, CompDisplay * d)
{
...
static Bool scaleaddonInitScreen(CompPlugin * p, CompScreen * s)
{
	ScaleAddonScreen *as;
...
static CompBool scaleaddonInitObject(CompPlugin * p, CompObject * o)
{
...
static void scaleaddonFiniObject(CompPlugin * p, CompObject * o)
{
...
static Bool scaleaddonInit(CompPlugin * p)
{
